...
Public Class Form3
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        con.ConnectionString = "Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Projects\Salon Management\SalonManagement-Version-UI\Salon-Booking-System\Salon-Booking-System\KNKSalon.mdf;Integrated Security=True"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Panel1.Hide()
        Groupbox2.Show()
        SelectedBarber.ImageLocation = ("D:\Projects\Salon Management\SalonManagement-Version-UI\Pictures\mf3.png")
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Panel1.Hide()
        Groupbox2.Show()
        SelectedBarber.ImageLocation = ("D:\Projects\Salon Management\SalonManagement-Version-UI\Pictures\lf3.png")
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Panel1.Hide()
        Groupbox2.Show()
        SelectedBarber.ImageLocation = ("D:\Projects\Salon Management\SalonManagement-Version-UI\Pictures\nf3.png")
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Panel1.Hide()
        Groupbox2.Show()
        SelectedBarber.ImageLocation = ("D:\Projects\Salon Management\SalonManagement-Version-UI\Pictures\jf3.png")
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        Panel1.Hide()
        Groupbox2.Show()
        SelectedBarber.ImageLocation = ("D:\Projects\Salon Management\SalonManagement-Version-UI\Pictures\af3.png")
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            ...
            Catch ex As SqlException
                ...
                ElseIf slot = "11:00 - 12:00" Then
                    MessageBox.Show("Barber already booked for " + Guna2GradientButton6.Text + " hours on " + Guna2DateTimePicker1.Text, "Booking Unsuccessful", MessageBoxButtons.OK, MessageBoxIcon.Error)
                ElseIf slot = "16:00 - 17:00" Then
                    MessageBox.Show("Barber already booked for " + Guna2GradientButton7.Text + " hours on " + Guna2DateTimePicker1.Text, "Booking Unsuccessful", MessageBoxButtons.OK, MessageBoxIcon.Error)
                ElseIf slot = "17:00 - 18:00" Then
                    MessageBox.Show("Barber already booked for " + Guna2GradientButton11.Text + " hours on " + Guna2DateTimePicker1.Text, "Booking Unsuccessful", MessageBoxButtons.OK, MessageBoxIcon.Error)
                ElseIf slot = "18:00 - 19:00" Then
                    MessageBox.Show("Barber already booked for " + Guna2GradientButton9.Text + " hours on " + Guna2DateTimePicker1.Text, "Booking Unsuccessful", MessageBoxButtons.OK, MessageBoxIcon.Error)
                ElseIf slot = "19:00 - 20:00" Then
                    MessageBox.Show("Barber already booked for " + Guna2GradientButton8.Text + " hours on " + Guna2DateTimePicker1.Text, "Booking Unsuccessful", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
            End Try
        End If
    End Sub
